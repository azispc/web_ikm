...
$lang = array_merge($lang,array(
	"LIMIT_JUDUL_KEGIATAN" => "Jumlah karakter judul kegiatan harus berada diantara %m1% sampai %m2%",
	"ALAMAT_FAIL" => "Jumlah karakter alamat harus berada diantara %m1% sampai %m2%",
	"TEMPAT_LAHIR" => "Jumlah karakter tempat lahir harus berada diantara %m1% sampai %m2%",
	"LIMIT_TEMPAT_KEGIATAN" => "Jumlah karakter tempat kegiatan harus berada diantara %m1% sampai %m2%",
	"LIMIT_DESKRIPSI_KEGIATAN" => "Jumlah karakter deskripsi kegiatan harus berada diantara %m1% sampai %m2%",
	...
	"ACCOUNT_SPECIFY_BIRTHDAY"			=> "Tanggal Lahir tidak boleh kosong",
	"ACCOUNT_SPECIFY_RT"			=> "RT belum dipilih",
	"ACCOUNT_SPECIFY_RW"			=> "RW belum dipilih",
	"ACCOUNT_SPECIFY_WORK"			=> "Pekerjaan belum dipilih",
	"ACCOUNT_SPECIFY_GAJI"			=> "Penghasilan per bulan belum dipilih",
	...
	"ACCOUNT_USER_CHAR_LIMIT"		=> "Jumlah karakter username harus berada diantara %m1% sampai %m2%",
	"NAMA_LENGKAP_FAIL"		=> "Jumlah karakter nama lengkap harus berada diantara %m1% sampai %m2%",
	"JUDUL_LIMIT"		=> "Jumlah karakter judul harus berada diantara %m1% sampai %m2%",
	"KELUHAN_LIMIT"		=> "Jumlah karakter isi keluhan harus berada diantara %m1% sampai %m2%",
	"ACCOUNT_DISPLAY_CHAR_LIMIT"		=> "Your display name must be between %m1% and %m2% characters in length",
	"KTP_FAIL"		=> "Masukkan %m2% digit nomor KTP" ,
	"KTP_EXIST"		=> "Nomor KTP sudah terdaftar !" ,
	"USERNAME_EXIST"		=> "Username telah terdaftar !" ,
	"ACCOUNT_PASS_CHAR_LIMIT"		=> "Jumlah karakter password harus berada diantara %m1% sampai %m2%",
	"ACCOUNT_TITLE_CHAR_LIMIT"		=> "Titles must be between %m1% and %m2% characters in length",
	"ACCOUNT_PASS_MISMATCH"			=> "Password dan Konfirmasi Password harus sama",
	...
	"ACCOUNT_USER_INVALID_CHARACTERS"	=> "Username hanya boleh berisikan huruf alphabet dan angka",
