<?php
	...
	header("Content-Disposition: attachment; filename=Hasil_Survei_Triwulan.xls");
    include 'connect.php';
    $id_kategorisend=$_GET['id'];
    if(isset($_GET['from'], $_GET['to'])){
    $result ='';
    $query = "SELECT * FROM responden join jawaban_user where id_kategoriResponden='$id_kategorisend' AND id_respondenj=id_responden AND tanggal BETWEEN '".$_GET['from']."' AND '".$_GET['to']."'";
                ...
                <?php
                    ...
                    <tbody>
                        ...
                        <?php
                                ...
                                $queryj = mysqli_query($connect,"SELECT  COUNT(*) AS jumlah FROM responden join jawaban_user where id_kategoriResponden='$id_kategorisend' AND id_respondenj=id_responden AND tanggal BETWEEN '".$_GET['from']."' AND '".$_GET['to']."'");

                                $jumlah=mysqli_fetch_array($queryj);
                                $count=$jumlah ['jumlah'];
                          
                                $queryv = mysqli_query($connect,"SELECT * FROM responden join jawaban_user where id_kategoriResponden='$id_kategorisend' AND id_respondenj=id_responden AND tanggal BETWEEN '".$_GET['from']."' AND '".$_GET['to']."'");
